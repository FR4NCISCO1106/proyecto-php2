...
<head>
  ...
  <body>
    ...
    <div class="temas-alignment">
      ...
      <form id = "form1" name = "form1" method = "post" action = "./agregar_respuesta.php">
        <table id="temas">
          ...
          <tr>
            ...
            <td><input type="text" name="me_gusta" id="me_gusta" /> </td>
            <input name="oculto" type="hidden" id="oculto" value="<?php print $ver[0];?>" />
          </tr>
          <tr>
      ...
      <?php
        $sql2 = "SELECT id, id_tema, autor, fecha, respuesta, pais, me_gusta FROM respuesta WHERE id_tema = '$ver[0]' ORDER BY id DESC";
      ...
      ?>
        ...
        <p>pais: <?php print $ver2[4]; ?> </p>
        <p>me_gusta: <?php print $ver2[4]; ?> </p>
        <hr class="temas-hr">
      <?php } ?>
    </div>
  </body>
